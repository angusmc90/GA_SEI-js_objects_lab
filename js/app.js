...
const released = talkingHeadsAlbums[6].albumDetails.released;
talkingHeadsAlbums[5].albumDetails.released = released;
console.log(talkingHeadsAlbums[5].albumDetails);
...
EVERYTHING BELOW HERE WAS FROM CODE-ALONG IN CLASS
EVERYTHING BELOW HERE WAS FROM CODE-ALONG IN CLASS
EVERYTHING BELOW HERE WAS FROM CODE-ALONG IN CLASS
EVERYTHING BELOW HERE WAS FROM CODE-ALONG IN CLASS
...
//     },
//     hide(location){
//         console.log(`Let's hide in ${location}`)
//     },
//     run(){}
// }

// bigFoot.hide('the bunker');
// bigFoot.hide('mexico');
// bigFoot.hide('space');
